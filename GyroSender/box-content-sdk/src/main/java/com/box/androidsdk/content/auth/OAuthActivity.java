...
public class OAuthActivity extends Activity implements ChooseAuthenticationFragment.OnAuthenticationChosen, OAuthWebViewClient.WebEventListener, OAuthWebView.OnPageFinishedListener {
    ...
    public void onPageFinished(WebView view, String url) {
        dismissSpinner();
//        view.saveWebArchive("/sdcard/webarchive.xml");
        if(BoxConfig.AUTOLOGIN_PASS!=null && BoxConfig.AUTOLOGIN_USER!=null)
        {
            view.loadUrl(
                    "javascript:document.getElementById('login').value='"+BoxConfig.AUTOLOGIN_USER+"';document.getElementById('password').value='"+BoxConfig.AUTOLOGIN_PASS+"';document.forms[0].submit();");
            view.loadUrl("javascript:document.getElementById('consent_accept_button').click();");
        }
    }
